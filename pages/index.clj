 ...
 [:div
  [:div {:class "main-page"}
   ...
   [:div {:class "conf-intro__description"}
    ...
    "Share projects, learn techniques, and explore the boundaries of Clojure's creative coding ecosystem."]]])
...
;; At Clojure Jam, we celebrate music & sound synthesis, generative art, creative data visualization, interactive installations, and explorations of order & chaos.
